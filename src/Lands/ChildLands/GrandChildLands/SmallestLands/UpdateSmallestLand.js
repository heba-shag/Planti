...
export default function UpdateSmallestLand(){
    ...
    const grandLinkId=window.location.pathname.split("/").slice(-5)[0];  
    const bigLand=window.location.pathname.split("/").slice(-7)[0];  
    ...
    return(
        ...
        <UpdateForm
            ...
            direction={`lands/child/${bigLand}/grandchild/${grandLinkId}/pieceLand/${parentLinkId}`}
